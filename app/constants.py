...
IDEA_USER_PROMPT = (
    'Меня интересуют следующие темы: {tags}. '
    'Уже были использованы данные идеи: {ideas}. '
...
TASK_SYSTEM_PROMPT = (
    ...
    'задачи и дать ей описание, составить техническое задание, подразумевающее ряд справедливых требований '
